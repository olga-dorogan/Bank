USE `bank_db`;
CREATE TABLE client(id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(45), surname VARCHAR(45) );
...
INSERT INTO client(id, name, surname) VALUES(1, 'Ivan', 'Ivanov');
INSERT INTO client(id, name, surname) VALUES(2, 'Petr', 'Petrov');
